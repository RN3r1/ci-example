...
var _ = common._;
var substractTwoNumbers = common.substractTwoNumbers;
...
it('should add two numbers', function () {
    ...
    // 2. ACT
    var sum2 = substractTwoNumbers(x, y);
  ...
  it('should work with expansion', function () {
    ...
    var sum2 = substractTwoNumbers(x-y, (z));
  ...
  it('should work with lots of numbers', function () {
    ...
    numbers1.map((number, index)=>{
        ...
        let calculatedSum = substractTwoNumbers(number, index);
