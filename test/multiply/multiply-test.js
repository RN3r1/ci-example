...
var _ = common._;
var multiplyTwoNumbers = common.multiplyTwoNumbers;
...
it('should add two numbers', function () {
    ...
    // 2. ACT
    var sum2 = multiplyTwoNumbers(x, y);
  ...
  it('should work with expansion', function () {
    ...
    var sum2 = multiplyTwoNumbers(x, (y*z));
  ...
  it('should work with lots of numbers', function () {
    ...
    numbers1.map((number, index)=>{
        ...
        let calculatedSum = multiplyTwoNumbers(number, index);
